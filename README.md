...
* [grbl](https://github.com/grbl/grbl) ⭐ 6,263 | 🐛 564 | 🌐 C | 📅 2024-06-02 - A high-performance G-code interpreting firmware for the Atmega 328 microcontroller and Arduino.
...
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,249 | 🐛 194 | 🌐 Java | 📅 2026-08-20 - Java-based grbl-compatible cross-platform G-code sender.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,645 | 🐛 257 | 🌐 JavaScript | 📅 2026-08-19 - Node.js-based tool for optimizing SVG files.
