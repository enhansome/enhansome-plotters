...
* [openBrushograph](https://github.com/openBrushograph/openBrushograph_hardware) ⭐ 25 | 🐛 0 | 🌐 OpenSCAD | 📅 2026-09-20 - Open source 3d-printable XY gantry and Z-stage designed for automated brush and pen painting.
...
* [TinyG](https://github.com/synthetos/TinyG) ⭐ 945 | 🐛 72 | 🌐 G-code | 📅 2025-09-06 - More featureful and robust 6-axis G-code-based motion control hardware. ([adafruit](https://www.adafruit.com/product/1749))
...
* [PlotAdapter](https://github.com/rhalkyard/plotadapter) ⭐ 26 | 🐛 0 | 🌐 C++ | 📅 2022-05-12 - "Serial-GPIB converter for HP Plotters", uses an Arduino microcontroller to convert serial HPGL to the GPIB/HP-IB expected by some older HP plotters.
...
* [grbl](https://github.com/grbl/grbl) ⭐ 6,282 | 🐛 566 | 🌐 C | 📅 2024-06-02 - A high-performance G-code interpreting firmware for the Atmega 328 microcontroller and Arduino.
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,647 | 🐛 141 | 🌐 JavaScript | 📅 2026-09-21 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,263 | 🐛 192 | 🌐 Java | 📅 2026-09-12 - Java-based grbl-compatible cross-platform G-code sender.
...
* [gcode-generative-for-processing](https://github.com/o0morgan0o/gcode-generative-for-processing) ⭐ 36 | 🐛 1 | 🌐 Java | 📅 2020-02-28 - Processing library, aiming to create gcode from simple shapes. (Designed for usage with the Creality CR10)
...
* [LaserGRBL](https://github.com/arkypita/LaserGRBL) ⭐ 1,651 | 🐛 618 | 🌐 C# | 📅 2025-05-29 - Laser-optimized Windows GUI for grbl controllers. Could be repurposed for DIY pen plotters that use a solenoid for pen up/down movements.
* [GRBL-Plotter](https://github.com/svenhb/GRBL-Plotter) ⭐ 897 | 🐛 22 | 🌐 C# | 📅 2026-08-16 - Plotter-optimized Windows GUI for grbl controller with SVG and DXF import, and flexible pen up/down control.
...
* [Inkcut](https://github.com/inkcut/inkcut) ⭐ 428 | 🐛 151 | 🌐 Python | 📅 2026-09-11 - Application for controlling 2D plotters, cutters, engravers, and CNC machines.
...
* [PenPlotter](https://github.com/RickMcConney/PenPlotter) ⭐ 128 | 🐛 22 | 🌐 C | 📅 2018-12-24 - Polargraph controller that uses repetier firmware.
...
* [py\_silhouette](https://github.com/mossblaser/py_silhouette) ⭐ 45 | 🐛 4 | 🌐 Python | 📅 2025-11-12 - Python library for controlling Silhouette plotters and cutters.
* [plottie](https://github.com/mossblaser/plottie) ⭐ 39 | 🐛 2 | 🌐 Python | 📅 2024-06-01 - Command-line tool for controlling Silhouette plotters and cutters with SVG input.
...
* [ln](https://github.com/fogleman/ln) ⭐ 3,378 | 🐛 12 | 🌐 Go | 📅 2019-07-19 - Vector-based 3D renderer written in Go.
* [linedraw](https://github.com/LingDong-/linedraw) ⭐ 864 | 🐛 7 | 🌐 Python | 📅 2023-07-22 - Python tool to convert images to sketchy vector line drawings.
* [autotrace](https://github.com/autotrace/autotrace) ⭐ 735 | 🐛 21 | 🌐 C | 📅 2026-09-21 - Converts bitmap images to vector graphics.
* [DrawingBotV3](https://github.com/SonarSonic/DrawingBotV3) ⭐ 521 | 🐛 48 | 🌐 Java | 📅 2025-10-08 - Cross-platform software for converting images to line drawings.
* [stipplegen](https://github.com/evil-mad/stipplegen) ⭐ 484 | 🐛 9 | 🌐 Processing | 📅 2022-04-09 - Creates interesting stippled drawings from bitmap images. ([blog post](https://www.evilmadscientist.com/2012/stipplegen2))
* [SquiggleDraw](https://github.com/gwygonik/SquiggleDraw/commits/master) ⭐ 337 | 🐛 0 | 🌐 Processing | 📅 2023-01-28 - "SquiggleDraw will create a SVG file from an image, using the brightness to change the amplitude of sine waves".
* [penplot](https://github.com/mattdesl/penplot) ⭐ 274 | 🐛 1 | 🌐 JavaScript | 📅 2018-06-08 - A development environment for plotter art in JavaScript.
...
* [plotting-maps](https://github.com/piebro/plotting-maps) ⭐ 109 | 🐛 0 | 🌐 HTML | 📅 2026-08-05 - A simple web tool to create OpenStreetMap SVG maps for plotting.
* [blackstripes](https://github.com/fullscreennl/blackstripes-python-extensions) ⭐ 102 | 🐛 7 | 🌐 C | 📅 2026-09-02 - Turns a PNG image into a SVG line drawing.
* [cozyvec](https://github.com/brubsby/cozyvec) ⭐ 76 | 🐛 5 | 🌐 JavaScript | 📅 2024-04-12 - Web/Standalone terminal environment for plotter art and tweet plots.
...
* [scribbleplot](https://github.com/bleeptrack/scribbleplot) ⭐ 52 | 🐛 0 | 🌐 Processing | 📅 2018-02-22 - Scribbly image transformations in Processing.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,700 | 🐛 272 | 🌐 JavaScript | 📅 2026-08-27 - Node.js-based tool for optimizing SVG files.
* [vpype](https://github.com/abey79/vpype) ⭐ 940 | 🐛 66 | 🌐 Python | 📅 2026-09-19 - Plotter-focused Python-based CLI utility for generating and manipulating SVGs, including scaling and optimizing paths.
...
* [svgoutline](https://github.com/mossblaser/svgoutline) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2026-09-20 - Python library to extract strokes and outlines from SVGs as line segments.
...
* [hershey-fonts](https://github.com/kamalmostafa/hershey-fonts) ⭐ 97 | 🐛 3 | 🌐 C | 📅 2018-01-01 - C library and original font data for the Hershey fonts.
...
* [awesome-generative-art](https://github.com/kosmos/awesome-generative-art) ⭐ 1,843 | 🐛 12 | 📅 2024-06-04
