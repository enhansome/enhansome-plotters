...
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,634 | 🐛 141 | 🌐 JavaScript | 📅 2026-08-05 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
...
* [linedraw](https://github.com/LingDong-/linedraw) ⭐ 857 | 🐛 6 | 🌐 Python | 📅 2023-07-22 - Python tool to convert images to sketchy vector line drawings.
* [autotrace](https://github.com/autotrace/autotrace) ⭐ 719 | 🐛 21 | 🌐 C | 📅 2026-08-08 - Converts bitmap images to vector graphics.
