...
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,639 | 🐛 142 | 🌐 JavaScript | 📅 2026-08-20 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
...
* [autotrace](https://github.com/autotrace/autotrace) ⭐ 727 | 🐛 21 | 🌐 C | 📅 2026-08-24 - Converts bitmap images to vector graphics.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,654 | 🐛 257 | 🌐 JavaScript | 📅 2026-08-25 - Node.js-based tool for optimizing SVG files.
