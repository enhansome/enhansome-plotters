...
* [openBrushograph](https://github.com/openBrushograph/openBrushograph_hardware) ⭐ 24 | 🐛 0 | 🌐 OpenSCAD | 📅 2026-09-19 - Open source 3d-printable XY gantry and Z-stage designed for automated brush and pen painting.
...
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,648 | 🐛 143 | 🌐 JavaScript | 📅 2026-09-13 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,259 | 🐛 191 | 🌐 Java | 📅 2026-09-12 - Java-based grbl-compatible cross-platform G-code sender.
...
* [ln](https://github.com/fogleman/ln) ⭐ 3,376 | 🐛 12 | 🌐 Go | 📅 2019-07-19 - Vector-based 3D renderer written in Go.
...
* [autotrace](https://github.com/autotrace/autotrace) ⭐ 731 | 🐛 21 | 🌐 C | 📅 2026-09-14 - Converts bitmap images to vector graphics.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,683 | 🐛 272 | 🌐 JavaScript | 📅 2026-08-27 - Node.js-based tool for optimizing SVG files.
...
* [svgoutline](https://github.com/mossblaser/svgoutline) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2024-06-04 - Python library to extract strokes and outlines from SVGs as line segments.
