...
* [autotrace](https://github.com/autotrace/autotrace) ⭐ 726 | 🐛 21 | 🌐 C | 📅 2026-08-17 - Converts bitmap images to vector graphics.
* [DrawingBotV3](https://github.com/SonarSonic/DrawingBotV3) ⭐ 513 | 🐛 48 | 🌐 Java | 📅 2025-10-08 - Cross-platform software for converting images to line drawings.
...
* [plotting-maps](https://github.com/piebro/plotting-maps) ⭐ 106 | 🐛 0 | 🌐 HTML | 📅 2026-08-05 - A simple web tool to create OpenStreetMap SVG maps for plotting.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,647 | 🐛 253 | 🌐 JavaScript | 📅 2026-08-23 - Node.js-based tool for optimizing SVG files.
