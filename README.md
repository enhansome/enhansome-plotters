...
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,647 | 🐛 144 | 🌐 JavaScript | 📅 2026-09-20 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,260 | 🐛 192 | 🌐 Java | 📅 2026-09-12 - Java-based grbl-compatible cross-platform G-code sender.
...
* [LaserGRBL](https://github.com/arkypita/LaserGRBL) ⭐ 1,638 | 🐛 617 | 🌐 C# | 📅 2025-05-29 - Laser-optimized Windows GUI for grbl controllers. Could be repurposed for DIY pen plotters that use a solenoid for pen up/down movements.
* [GRBL-Plotter](https://github.com/svenhb/GRBL-Plotter) ⭐ 894 | 🐛 22 | 🌐 C# | 📅 2026-08-16 - Plotter-optimized Windows GUI for grbl controller with SVG and DXF import, and flexible pen up/down control.
...
* [plottie](https://github.com/mossblaser/plottie) ⭐ 39 | 🐛 3 | 🌐 Python | 📅 2024-06-01 - Command-line tool for controlling Silhouette plotters and cutters with SVG input.
...
* [autotrace](https://github.com/autotrace/autotrace) ⭐ 732 | 🐛 21 | 🌐 C | 📅 2026-09-14 - Converts bitmap images to vector graphics.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,686 | 🐛 274 | 🌐 JavaScript | 📅 2026-08-27 - Node.js-based tool for optimizing SVG files.
...
* [svgoutline](https://github.com/mossblaser/svgoutline) ⭐ 23 | 🐛 1 | 🌐 Python | 📅 2024-06-04 - Python library to extract strokes and outlines from SVGs as line segments.
...
* [awesome-generative-art](https://github.com/kosmos/awesome-generative-art) ⭐ 1,842 | 🐛 12 | 📅 2024-06-04
