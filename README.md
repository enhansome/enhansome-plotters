...
* [grbl](https://github.com/grbl/grbl) ⭐ 6,273 | 🐛 564 | 🌐 C | 📅 2024-06-02 - A high-performance G-code interpreting firmware for the Atmega 328 microcontroller and Arduino.
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,646 | 🐛 145 | 🌐 JavaScript | 📅 2026-09-06 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,253 | 🐛 192 | 🌐 Java | 📅 2026-09-06 - Java-based grbl-compatible cross-platform G-code sender.
...
* [linedraw](https://github.com/LingDong-/linedraw) ⭐ 862 | 🐛 7 | 🌐 Python | 📅 2023-07-22 - Python tool to convert images to sketchy vector line drawings.
* [autotrace](https://github.com/autotrace/autotrace) ⭐ 729 | 🐛 21 | 🌐 C | 📅 2026-08-31 - Converts bitmap images to vector graphics.
* [DrawingBotV3](https://github.com/SonarSonic/DrawingBotV3) ⭐ 517 | 🐛 48 | 🌐 Java | 📅 2025-10-08 - Cross-platform software for converting images to line drawings.
* [stipplegen](https://github.com/evil-mad/stipplegen) ⭐ 483 | 🐛 9 | 🌐 Processing | 📅 2022-04-09 - Creates interesting stippled drawings from bitmap images. ([blog post](https://www.evilmadscientist.com/2012/stipplegen2))
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,664 | 🐛 261 | 🌐 JavaScript | 📅 2026-08-27 - Node.js-based tool for optimizing SVG files.
